...
from src.utils.paths import SCATTER_PLOTS_RESULTS_DIR

METHOD_2_SCATTER_ROOT = SCATTER_PLOTS_RESULTS_DIR / "methodologie_2"
...
def main() -> None:
    ...
    for dataset_name in SPLIT_FILES:
        ...
        output_dir = METHOD_2_SCATTER_ROOT / dataset_slug(dataset_name)
        output_dir.mkdir(parents=True, exist_ok=True)

        desc_file, corr_file = save_summary_tables(data, output_dir)
        save_scatterplots(data, output_dir, dataset_name)
        save_correlation_heatmap(data, output_dir, dataset_name)
        save_candidate_feature_heatmaps(data, output_dir, dataset_name)
    ...
    summary_file = METHOD_2_SCATTER_ROOT / "summary_methodologie_2_scatter_plots.csv"
