...
from methodologie_1.common import COMPARE_DIR as INDIRECT_COMPARE_DIR, E_FROM_D_DIR as INDIRECT_E_FROM_D_DIR
...
def load_direct_summary() -> pd.DataFrame:
    ...
    return df.assign(method="methodologie_2").copy()
...
def main() -> None:
    ...
    print("=" * 100)
    print("COMPARAISON ENTRE LA METHODOLOGIE 2 ET LA METHODOLOGIE 1")
    print("=" * 100)
