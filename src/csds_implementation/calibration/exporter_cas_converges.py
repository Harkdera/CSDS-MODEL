...
from src.utils.paths import CSDS_CONVERGED_CASES_DIR, PROCESSED_DATA_DIR
...
def main():
    ...
    # -------------------------------------------------------------
    input_csv = PROCESSED_DATA_DIR / "csds_parameters_with_model.csv"
    ...
    # -------------------------------------------------------------
    output_csv = PROCESSED_DATA_DIR / "csds_parameters_converged_only.csv"
    output_csv.parent.mkdir(parents=True, exist_ok=True)
    df_converged.to_csv(output_csv, index=False)
    CSDS_CONVERGED_CASES_DIR.mkdir(parents=True, exist_ok=True)
    df_converged.to_csv(CSDS_CONVERGED_CASES_DIR / output_csv.name, index=False)
