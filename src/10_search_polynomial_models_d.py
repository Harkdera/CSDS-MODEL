...
def load_and_prepare(file_path):
    """Charge le jeu de données et reconstruit les variables dérivées utilisées par les modèles."""
...
def is_diverse_enough(feature_list, selected_models, similarity_threshold):
    """Vérifie qu'un nouveau modèle est suffisamment différent des modèles déjà retenus."""
    """
...
def setup_genetic_algorithm(train_df, val_df, all_features, cv_folds):
    ...
    def create_individual():
        ...
        return creator.IndividualCSDS(random.sample(all_features, n_features))
