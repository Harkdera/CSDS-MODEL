"""Recherche des meilleures combinaisons polynomiales pour prédire `log(e-c)`."""
...
from methodologie_2.search_utils import run_genetic_feature_search  # noqa: E402
...
def build_polynomial_model():
    """Construit le pipeline polynomial régularisé utilisé sur `z = log(e-c)`."""
    return Pipeline([
...
def main() -> None:
    ...
    print("=" * 100)
    print("RECHERCHE POLYNOMIALE SUR log(e-c)")
    print("=" * 100)
    ...
    for dataset_name in SPLIT_FILES:
        ...
        best_models, importance_df, logbook = run_genetic_feature_search(
            ...
            model_builder=build_polynomial_model,
        ...
        results_file = REGRESSION_DIR / f"poly_log_e_gap_selection_{dataset_slug(dataset_name)}.csv"
        importance_file = REGRESSION_DIR / f"feature_importance_poly_log_e_gap_{dataset_slug(dataset_name)}.csv"
