...
from src.utils.paths import (
    ...
    METHODOLOGIE_2_FIGURES_DIR as CANONICAL_METHOD_2_FIGURES_DIR,
    METHODOLOGIE_2_HEURISTIC_DIR,
    METHODOLOGIE_2_RECONSTRUCTED_DIR,
    METHODOLOGIE_2_RESULTS_DIR as CANONICAL_METHOD_2_RESULTS_DIR,
    PROCESSED_DATA_DIR,
    PROJECT_ROOT,
    RESULTS_DIR,
)
...
CONVERGED_FILE = PROCESSED_DATA_DIR / "csds_parameters_converged_only.csv"
METHOD_2_ROOT = CANONICAL_METHOD_2_RESULTS_DIR
METHOD_2_FIGURES_DIR = CANONICAL_METHOD_2_FIGURES_DIR
METHOD_2_MODEL_FIGURES_DIR = METHOD_2_FIGURES_DIR / "models"
METHOD_2_COMPARE_DIR = METHODOLOGIE_2_RECONSTRUCTED_DIR / "tau_u"
METHOD_COMPARISON_DIR = COMPARISON_RESULTS_DIR / "inter-methodologies"
LEGACY_METHOD_COMPARISON_DIR = METHOD_COMPARISON_DIR
SPLIT_FILES = {
    "FULL": CONVERGED_FILE,
...
DATASET_DIR = METHODOLOGIE_2_HEURISTIC_DIR / "prepared_datasets"
REGRESSION_DIR = METHODOLOGIE_2_HEURISTIC_DIR
TOP5_DIR = METHODOLOGIE_2_CROSS_VALIDATION_DIR / "top5"
EVALUATION_DIR = METHODOLOGIE_2_RECONSTRUCTED_DIR / "from_z"
FINAL_EVALUATION_DIR = FINAL_RESULTS_DIR
N_CURVE_POINTS = 100
RANDOM_SEED = 42
CV_FOLDS_BY_DATASET = {
    "FULL": 5,
