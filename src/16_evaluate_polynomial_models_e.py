"""Teste des régressions polynomiales pour prédire `e_csds` puis en déduit `d`."""
...
regression_dir = (output_dir / "regressions").resolve()
...
def load_and_clean(csv_path):
    """Charge un CSV et conserve uniquement les lignes exploitables pour la modélisation."""
...
def fit_and_evaluate_polynomial_model(train_df, val_df, feature_cols, degree, target_col="e_csds"):
    """Ajuste une régression polynomiale sur `e_csds` et retourne ses métriques."""
...
def compute_d_from_e(u_r, tau_r, u_p, tau_p, e):
    """Recalcule `d` à partir de `e` et des paramètres physiques du modèle CSDS."""
    a = tau_r
    c = 5.0 / u_r
...
def run_component_analysis(data, dataset_name):
    """Teste plusieurs degrés et ensembles de variables pour un sous-jeu donné."""
    print("\n" + "=" * 90)
...
# ============================================================
# 4) Exécuter l'analyse sur LOW
# ============================================================
low_data = load_and_clean(low_path)
summary_low, pred_low = run_component_analysis(low_data, "LOW")

# ============================================================
# 5) Exécuter l'analyse sur HIGH
# ============================================================
high_data = load_and_clean(high_path)
summary_high, pred_high = run_component_analysis(high_data, "HIGH")

# ============================================================
# 6) Enregistrer les sorties
# ============================================================
summary_low_path = regression_dir / "polynomial_component_analysis_e_low_deg234.csv"
summary_high_path = regression_dir / "polynomial_component_analysis_e_high_deg234.csv"

pred_low_path = regression_dir / "predicted_e_and_d_low_deg234.csv"
pred_high_path = regression_dir / "predicted_e_and_d_high_deg234.csv"
