...
from src.utils.paths import FINAL_REGULARIZED_REGRESSION_DIR, PROJECT_ROOT
...
OUTPUT_DIR = FINAL_REGULARIZED_REGRESSION_DIR / "base5_poly_log_e_gap_calibration_test"
