...
# ================================
INPUT_FILE = INTERIM_DATA_DIR / "csds_tau_peak_low.csv"
CONVERGED_FILE = PROCESSED_DATA_DIR / "csds_parameters_converged_only.csv"

OUTPUT_LOW_1 = INTERIM_DATA_DIR / "csds_tau_peak_low_1.csv"
OUTPUT_LOW_2 = INTERIM_DATA_DIR / "csds_tau_peak_low_2.csv"
OUTPUT_DIR = DATABASE_SPLIT_DIAGNOSTICS_DIR / "tau_peak_low_subgroups"
...
df_low_1.to_csv(DATABASE_SPLIT_DATASETS_DIR / OUTPUT_LOW_1.name, index=False)
df_low_2.to_csv(DATABASE_SPLIT_DATASETS_DIR / OUTPUT_LOW_2.name, index=False)

# ================================
# 4) Tracer l'histogramme global avec le seuil
# ================================
full_hist_path = OUTPUT_DIR / "tau_peak_low_hist_split_3_5.png"
