"""Utilitaires partagés pour le modèle final FULL de la méthodologie 2."""
...
INTERPRETATION_ROOT = FINAL_RECURRENT_VARIABLES_DIR
LEGACY_INTERPRETATION_ROOT = INTERPRETATION_ROOT
SCATTER_DIR = FINAL_RECURRENT_VARIABLES_DIR / "scatter_log_e_minus_c"
PCA_DIR = FINAL_PCA_DIR
CORRELATION_DIR = FINAL_RECURRENT_VARIABLES_DIR / "correlation"
LAMBDA_DIR = FINAL_LAMBDA_SEARCH_DIR
...
TOP10_FEATURES_FILE = FINAL_RECURRENT_VARIABLES_DIR / "top10_features_methodologie_2_full.csv"
TOP10_DATASET_FILE = FINAL_RECURRENT_VARIABLES_DIR / "methodologie_2_full_top10_dataset.csv"
...
def ensure_output_dirs() -> None:
    ...
    for path in [INTERPRETATION_ROOT, SCATTER_DIR, PCA_DIR, CORRELATION_DIR, LAMBDA_DIR]:
        path.mkdir(parents=True, exist_ok=True)


def mirror_legacy_outputs() -> None:
    """Conservé pour compatibilité d'API; la nouvelle structure est déjà canonique."""
    return None
