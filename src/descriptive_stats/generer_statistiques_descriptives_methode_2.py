...
from src.utils.paths import DESCRIPTIVE_STATS_RESULTS_DIR

METHOD_2_DESCRIPTIVE_ROOT = DESCRIPTIVE_STATS_RESULTS_DIR / "methodologie_2"
...
def main() -> None:
    ...
    for dataset_name in SPLIT_FILES:
        ...
        output_dir = METHOD_2_DESCRIPTIVE_ROOT / dataset_slug(dataset_name)
    ...
    summary_file = METHOD_2_DESCRIPTIVE_ROOT / "summary_methodologie_2_descriptive_stats.csv"
