...
from methodologie_1.common import build_d_dataset  # noqa: E402
from methodologie_2.common import build_direct_e_dataset  # noqa: E402
...
RANKING_FILE = (
    ...
    / "results"
    / "comparaison"
    / "model_selection_composite_score"
    / "composite_model_ranking_all_retained_models.csv"
)
OUTPUT_ROOT = PROJECT_ROOT / "results" / "interpretation"
...
def load_ranking() -> pd.DataFrame:
    if not RANKING_FILE.exists():
        raise FileNotFoundError(
            f"Missing ranking file: {RANKING_FILE}. Run src/19_rank_models_composite_score.py first."
        )
