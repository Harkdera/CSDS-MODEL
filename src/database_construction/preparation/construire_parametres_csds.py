...
from src.utils.paths import DATABASE_VARIABLE_PREPARATION_DIR, INTERIM_DATA_DIR


INPUT_FILE = INTERIM_DATA_DIR / "csds_full_table_clean.csv"
OUTPUT_FILE = INTERIM_DATA_DIR / "csds_parameters.csv"
...
DATABASE_VARIABLE_PREPARATION_DIR.mkdir(parents=True, exist_ok=True)
df.to_csv(DATABASE_VARIABLE_PREPARATION_DIR / OUTPUT_FILE.name, index=False)
