"""Outils génériques de recherche de combinaisons de variables pour la branche `direct_d`."""
...
try:
    from direct_d.common import RANDOM_SEED, compute_metrics
except ModuleNotFoundError:
    from common import RANDOM_SEED, compute_metrics
