...
OUTPUT_DIR = RESULTS_DIR / "comparaison" / "model_selection_composite_score"
N_CURVE_POINTS = 100
...
METHODS = {
    "methodologie_1": {
        "compare_summary": RESULTS_DIR / "methodologie_1" / "compare_d_b_e_tau_u" / "summary_all_models_compare_d_b_e_tau_u.csv",
        "top5_dir": RESULTS_DIR / "methodologie_1" / "regressions" / "top5",
    },
    "methodologie_2": {
        "compare_summary": RESULTS_DIR / "methodologie_2" / "compare_b_d_e_tau_u" / "summary_all_models_compare_b_d_e_tau_u.csv",
        "top5_dir": RESULTS_DIR / "methodologie_2" / "regressions" / "top5",
        "selection_dir": RESULTS_DIR / "methodologie_2" / "regressions",
    },
}
