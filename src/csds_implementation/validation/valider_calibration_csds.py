...
from src.utils.paths import CSDS_VALIDATION_RESULTS_DIR, TEST_DATA_DIR

INPUT_CSV = TEST_DATA_DIR / "csds_calibration_test.csv"
OUTPUT_DIR = CSDS_VALIDATION_RESULTS_DIR
