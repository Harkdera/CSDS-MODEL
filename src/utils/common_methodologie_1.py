...
from src.utils.paths import (
    ...
    METHODOLOGIE_1_FIGURES_DIR as CANONICAL_METHOD_1_FIGURES_DIR,
    METHODOLOGIE_1_HEURISTIC_DIR,
    METHODOLOGIE_1_RECONSTRUCTED_DIR,
    METHODOLOGIE_1_RESULTS_DIR as CANONICAL_METHOD_1_RESULTS_DIR,
    PROCESSED_DATA_DIR,
    PROJECT_ROOT,
    RESULTS_DIR,
)
...
METHOD_1_RESULTS_DIR = CANONICAL_METHOD_1_RESULTS_DIR
METHOD_1_FIGURES_DIR = CANONICAL_METHOD_1_FIGURES_DIR
...
REGRESSION_DIR = METHODOLOGIE_1_HEURISTIC_DIR
TOP5_DIR = METHODOLOGIE_1_CROSS_VALIDATION_DIR / "top5"
E_FROM_D_DIR = METHODOLOGIE_1_RECONSTRUCTED_DIR / "e_from_d"
B_FROM_D_DIR = METHODOLOGIE_1_RECONSTRUCTED_DIR / "b_from_d"
COMPARE_DIR = METHODOLOGIE_1_RECONSTRUCTED_DIR / "tau_u"
N_CURVE_POINTS = 100
RANDOM_SEED = 42
CV_FOLDS_BY_DATASET = {
    "FULL": 5,
