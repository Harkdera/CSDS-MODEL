...
try:
    from methodologie_1.common import TOP5_DIR, E_FROM_D_DIR, SPLIT_FILES, dataset_group, build_d_dataset, parse_feature_list, compute_metrics
except ModuleNotFoundError:
    from common import TOP5_DIR, E_FROM_D_DIR, SPLIT_FILES, dataset_group, build_d_dataset, parse_feature_list, compute_metrics
